...
namespace Cartify.Infrastructure.Migrations
{
    ...
    [Migration("20251030203811_siuuuuuuuuuu")]
    partial class siuuuuuuuuuu
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cartify.Domain.Models.TblOrder", b =>
                {
                    ...
                    b.HasIndex(new[] { "StoreId" }, "IX_TblOrders_UserStoreId");
            ...
            modelBuilder.Entity("TblUserStoreCustomers", b =>
                {
                    b.Property<int>("UserStoreId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("UserStoreId", "UserId");

                    b.HasIndex("UserId");

                    b.ToTable("TblUserStoreCustomers", (string)null);
                });
            ...
            modelBuilder.Entity("Cartify.Domain.Models.TblUser", b =>
                {
                    b.HasOne("Cartify.Domain.Models.TblUserStore", "UserStore")
                        .WithOne("Merchant")
                        .HasForeignKey("Cartify.Domain.Models.TblUser", "UserStoreId")
                        .IsRequired()
            ...
            modelBuilder.Entity("TblUserStoreCustomers", b =>
                {
                    ...
                    b.HasOne("Cartify.Domain.Models.TblUserStore", null)
                        .WithMany()
                        .HasForeignKey("UserStoreId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
